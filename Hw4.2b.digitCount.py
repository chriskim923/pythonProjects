...
# Implement the function  digitCount(number, digit) after this line

def digitCount(number, digit):
...
assert(digitCount(456234, 8) == 0)
assert(digitCount(456234, 5) == 1)
assert(digitCount(456234, 4) == 2)
assert(digitCount(-456234, 4) == 2)
assert(digitCount(0, 0) == 1)
